...
export function NeuralNoise({ color = [0.15, 0.15, 0.25], opacity = 0.35, speed = 0.0007 }: NeuralNoiseProps) {
  ...
  return (
    <canvas
      ref={canvasRef}
      className="neural-noise-canvas absolute inset-0 w-full h-full pointer-events-none"
      style={{
        position: 'absolute',
        top: 0,
        left: 0,
